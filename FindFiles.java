...
//ArrayList
	...
	*/
	...
	public static void findCitances(String testName)
	{
		...
		printMethodCounts(methodCounts);
		citanceannotations = FindReferenceAnnotation.findAnnotationlines(allAnnotationLines);
			reference = FindCitation.findReferenceText(testName);
				...
				//Task 4
				//Training 2018 als Trainingsdaten nehmen
				// Testdaten --> Testdaten 2018
				// alle xml Datein einlesen und in HashMaps speichern
				//mit Hilfe von SVM , den passenden Referenzsatz finden
				
			//	CompareCitationandReference.findCitances(citancelines, referencelines);
				//--> ist eine Art ersatz für SVM, wenn du Task 4 nicht schaffst, musst dann nur noch die Tabelle erstellen und ein paar eigene methoden schreiben
